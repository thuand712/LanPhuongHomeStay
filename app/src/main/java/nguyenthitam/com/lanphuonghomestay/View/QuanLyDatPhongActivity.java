...
public class QuanLyDatPhongActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quanlydatphong);
    ...
    private void AnhXa() {
        ...
        hinh12Adapter = new HinhAdapter(QuanLyDatPhongActivity.this, R.layout.custom_quanlydatphong, dsHinh12);
        ...
        dsHinh11.add(new Hinh(R.drawable.hinhqldp2));
        dsHinh11.add(new Hinh(R.drawable.hinhqldp2));
        hinh11Adapter = new HinhAdapter(QuanLyDatPhongActivity.this, R.layout.custom_quanlydatphong, dsHinh11);
